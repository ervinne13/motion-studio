...
function buildExtend(wf, { imageFilename, videoFilename, fps, frameCount, startFrame, prompt, seed, prefix, prevVideoFile, replacementMode }) {
  ...
  w['198:189'].inputs.replacement_mode    = replacementMode;
  w['198:186'].inputs.replacement_mode    = replacementMode;
...
export async function generateQwenEdit({ videoPath, frameIndex, prompt, supportImagePath, nsfw, outputPath, prefix }) {
