...
import { loadProject, projectDir } from './project.js';
  ...
  try {
    ...
    if (job.params?.jobType === 'qwen-edit') {
      ...
      if (use2xFps) {
        ...
        await enqueue({ jobType: 'rife-2x', projectId, projectName, inputPath: outPath, outputPath: rife2xPath, outputFile: rife2xFile });
